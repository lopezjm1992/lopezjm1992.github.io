 ...
 *
 * @license MIT
 */function mv(e,t){return e===t&&(e!==0||1/e===1/t)||e!==e&&t!==t}const Av=typeof Object.is=="function"?Object.is:mv,{useState:gv,useEffect:vv,useLayoutEffect:bv,useDebugValue:wv}=es;function Ev(e,t,n){const r=t(),[{inst:o},i]=gv({inst:{value:r,getSnapshot:t}});return bv(()=>{o.value=r,o.getSnapshot=t,Gl(o)&&i({inst:o})},[e,r,t]),vv(()=>(Gl(o)&&i({inst:o}),e(()=>{Gl(o)&&i({inst:o})})),[e]),wv(r),r}function Gl(e){const t=e.getSnapshot,n=e.value;try{const r=t();return!Av(n,r)}catch{return!0}}function xv(e,t,n){return t()}const kv=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",Cv=!kv,Sv=Cv?xv:Ev,Bv="useSyncExternalStore"in es?(e=>e.useSyncExternalStore)(es):Sv,rd=Q.createContext(null),od=Q.createContext(null),id=Q.createContext(null),sl=Q.createContext(null),ki=Q.createContext({outlet:null,matches:[]}),Fh=Q.createContext(null);function Js(){return Js=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Js.apply(this,arguments)}function ul(){return Q.useContext(sl)!=null}function Uh(){return ul()||ae(!1),Q.useContext(sl).location}function Lv(){ul()||ae(!1);let{basename:e,navigator:t}=Q.useContext(id),{matches:n}=Q.useContext(ki),{pathname:r}=Uh(),o=JSON.stringify(td(n).map(p=>p.pathnameBase)),i=Q.useRef(!1);return Q.useEffect(()=>{i.current=!0}),Q.useCallback(function(p,h){if(h===void 0&&(h={}),!i.current)return;if(typeof p=="number"){t.go(p);return}let A=_h(p,JSON.parse(o),r,h.relative==="path");e!=="/"&&(A.pathname=A.pathname==="/"?e:zn([e,A.pathname])),(h.replace?t.replace:t.push)(A,h.state,h)},[e,t,o,r])}function Iv(e,t){ul()||ae(!1);let{navigator:n}=Q.useContext(id),r=Q.useContext(od),{matches:o}=Q.useContext(ki),i=o[o.length-1],s=i?i.params:{};i&&i.pathname;let p=i?i.pathnameBase:"/";i&&i.route;let h=Uh(),A;if(t){var k;let g=typeof t=="string"?pn(t):t;p==="/"||(k=g.pathname)!=null&&k.startsWith(p)||ae(!1),A=g}else A=h;let E=A.pathname||"/",y=p==="/"?E:E.slice(p.length)||"/",L=zr(e,{pathname:y}),B=Pv(L&&L.map(g=>Object.assign({},g,{params:Object.assign({},s,g.params),pathname:zn([p,n.encodeLocation?n.encodeLocation(g.pathname).pathname:g.pathname]),pathnameBase:g.pathnameBase==="/"?p:zn([p,n.encodeLocation?n.encodeLocation(g.pathnameBase).pathname:g.pathnameBase])})),o,r||void 0);return t&&B?Q.createElement(sl.Provider,{value:{location:Js({pathname:"/",search:"",hash:"",state:null,key:"default"},A),navigationType:Be.Pop}},B):B}function _v(){let e=Nv(),t=Th(e)?e.status+" "+e.statusText:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,o={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"},i=null;return Q.createElement(Q.Fragment,null,Q.createElement("h2",null,"Unexpected Application Error!"),Q.createElement("h3",{style:{fontStyle:"italic"}},t),n?Q.createElement("pre",{style:o},n):null,i)}class Tv extends Q.Component{constructor(t){super(t),this.state={location:t.location,error:t.error}}static getDerivedStateFromError(t){return{error:t}}static getDerivedStateFromProps(t,n){return n.location!==t.location?{error:t.error,location:t.location}:{error:t.error||n.error,location:n.location}}componentDidCatch(t,n){console.error("React Router caught the following error during render",t,n)}render(){return this.state.error?Q.createElement(ki.Provider,{value:this.props.routeContext},Q.createElement(Fh.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function Rv(e){let{routeContext:t,match:n,children:r}=e,o=Q.useContext(rd);return o&&o.static&&o.staticContext&&(n.route.errorElement||n.route.ErrorBoundary)&&(o.staticContext._deepestRenderedBoundaryId=n.route.id),Q.createElement(ki.Provider,{value:t},r)}function Pv(e,t,n){if(t===void 0&&(t=[]),e==null)if(n!=null&&n.errors)e=n.matches;else return null;let r=e,o=n==null?void 0:n.errors;if(o!=null){let i=r.findIndex(s=>s.route.id&&(o==null?void 0:o[s.route.id]));i>=0||ae(!1),r=r.slice(0,Math.min(r.length,i+1))}return r.reduceRight((i,s,p)=>{let h=s.route.id?o==null?void 0:o[s.route.id]:null,A=null;n&&(s.route.ErrorBoundary?A=Q.createElement(s.route.ErrorBoundary,null):s.route.errorElement?A=s.route.errorElement:A=Q.createElement(_v,null));let k=t.concat(r.slice(0,p+1)),E=()=>{let y=i;return h?y=A:s.route.Component?y=Q.createElement(s.route.Component,null):s.route.element&&(y=s.route.element),Q.createElement(Rv,{match:s,routeContext:{outlet:i,matches:k},children:y})};return n&&(s.route.ErrorBoundary||s.route.errorElement||p===0)?Q.createElement(Tv,{location:n.location,component:A,error:h,children:E(),routeContext:{outlet:null,matches:k}}):E()},null)}var tp;(function(e){e.UseBlocker="useBlocker",e.UseRevalidator="useRevalidator"})(tp||(tp={}));var Ha;(function(e){e.UseBlocker="useBlocker",e.UseLoaderData="useLoaderData",e.UseActionData="useActionData",e.UseRouteError="useRouteError",e.UseNavigation="useNavigation",e.UseRouteLoaderData="useRouteLoaderData",e.UseMatches="useMatches",e.UseRevalidator="useRevalidator"})(Ha||(Ha={}));function zv(e){let t=Q.useContext(od);return t||ae(!1),t}function Ov(e){let t=Q.useContext(ki);return t||ae(!1),t}function Dv(e){let t=Ov(),n=t.matches[t.matches.length-1];return n.route.id||ae(!1),n.route.id}function Nv(){var e;let t=Q.useContext(Fh),n=zv(Ha.UseRouteError),r=Dv(Ha.UseRouteError);return t||((e=n.errors)==null?void 0:e[r])}function Mv(e){let{fallbackElement:t,router:n}=e,r=Q.useCallback(()=>n.state,[n]),o=Bv(n.subscribe,r,r),i=Q.useMemo(()=>({createHref:n.createHref,encodeLocation:n.encodeLocation,go:h=>n.navigate(h),push:(h,A,k)=>n.navigate(h,{state:A,preventScrollReset:k==null?void 0:k.preventScrollReset}),replace:(h,A,k)=>n.navigate(h,{replace:!0,state:A,preventScrollReset:k==null?void 0:k.preventScrollReset})}),[n]),s=n.basename||"/",p=Q.useMemo(()=>({router:n,navigator:i,static:!1,basename:s}),[n,i,s]);return Q.createElement(Q.Fragment,null,Q.createElement(rd.Provider,{value:p},Q.createElement(od.Provider,{value:o},Q.createElement(Fv,{basename:n.basename,location:n.state.location,navigationType:n.state.historyAction,navigator:i},n.state.initialized?Q.createElement(Uv,null):t))),null)}function jv(e){ae(!1)}function Fv(e){let{basename:t="/",children:n=null,location:r,navigationType:o=Be.Pop,navigator:i,static:s=!1}=e;ul()&&ae(!1);let p=t.replace(/^\/*/,"/"),h=Q.useMemo(()=>({basename:p,navigator:i,static:s}),[p,i,s]);typeof r=="string"&&(r=pn(r));let{pathname:A="/",search:k="",hash:E="",state:y=null,key:L="default"}=r,B=Q.useMemo(()=>{let g=ll(A,p);return g==null?null:{location:{pathname:g,search:k,hash:E,state:y,key:L},navigationType:o}},[p,A,k,E,y,L,o]);return B==null?null:Q.createElement(id.Provider,{value:h},Q.createElement(sl.Provider,{children:n,value:B}))}function Uv(e){let{children:t,location:n}=e,r=Q.useContext(rd),o=r&&!t?r.router.routes:Gs(t);return Iv(o,n)}var np;(function(e){e[e.pending=0]="pending",e[e.success=1]="success",e[e.error=2]="error"})(np||(np={}));new Promise(()=>{});function Gs(e,t){t===void 0&&(t=[]);let n=[];return Q.Children.forEach(e,(r,o)=>{if(!Q.isValidElement(r))return;if(r.type===Q.Fragment){n.push.apply(n,Gs(r.props.children,t));return}r.type!==jv&&ae(!1),!r.props.index||!r.props.children||ae(!1);let i=[...t,o],s={id:r.props.id||i.join("-"),caseSensitive:r.props.caseSensitive,element:r.props.element,Component:r.props.Component,index:r.props.index,path:r.props.path,loader:r.props.loader,action:r.props.action,errorElement:r.props.errorElement,ErrorBoundary:r.props.ErrorBoundary,hasErrorBoundary:r.props.ErrorBoundary!=null||r.props.errorElement!=null,shouldRevalidate:r.props.shouldRevalidate,handle:r.props.handle,lazy:r.props.lazy};r.props.children&&(s.children=Gs(r.props.children,i)),n.push(s)}),n}function qv(e){return Boolean(e.ErrorBoundary)||Boolean(e.errorElement)}/**
